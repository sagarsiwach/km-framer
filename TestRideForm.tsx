...
// Import our component modules with the latest URLs
import {
    InputField,
    PhoneField,
    SubmitButton,
...
class ErrorBoundary extends React.Component {
    ...
    componentDidCatch(error, errorInfo) {
        console.error("TestRideForm error:", error, errorInfo)
    }
        ...
        if (this.state.hasError) {
            return (
                <div style={{ padding: 20, color: "red", textAlign: "center" }}>
                    <h3>Something went wrong with the Test Ride form.</h3>
...
export function TestRideForm({
    ...
    // Filter out Framer-specific props that shouldn't be passed to DOM elements
    const {
        willChangeTransform,
        layoutId,
        forceRender,
    ...
    return (
        <ErrorBoundary>
            <div style={containerStyle} {...safeProps}>
                {/* Hero Image Section */}
                <div
                    style={{
