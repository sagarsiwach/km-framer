                ...
                isMobile ? (
                    <div style={mobileContainerStyle}>
                        ...
                        <div style={mobileSummaryFooterStyle}>
                            <VehicleSummary
                                vehicleName={bookingContext.formData.vehicleName || ""}
                                vehicleCode={bookingContext.formData.vehicleCode || ""}
                                location={
                                ...
                                pincode={bookingContext.formData.pincode || ""}
                                totalPrice={bookingContext.formData.totalPrice || 0}
                                showEmiInfo={true}
                            />
                    ...
                    <div style={desktopContainerStyle}>
                        ...
                        <div style={desktopBookingStyle}>
                            <div style={desktopFormHeaderStyle}>
                                <h1 style={{ fontSize: "1.5rem", fontWeight: "bold", margin: 0 }}>{headingText}</h1>
                                <div style={{ fontSize: "1rem", color: tokens.colors.neutral[600], marginTop: 8 }}>{getStepTitle()}</div>
                                <div style={{ fontSize: "0.9rem", color: tokens.colors.neutral[500] }}>{getStepDescription()}</div>
                            </div>
